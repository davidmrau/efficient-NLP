...
class MSMarco(data.Dataset):
    ...
    def __init__(self, dataset_path, split, docs_offset_list, debug=False):
        ...
        if split == 'train':
            ...
            if not debug:
                self.triplets_offset_list = read_pickle(f'{triplets_fname}.offset_dict.p')
        ...
        self.docs_file = open(f'{dataset_path}/collection.tsv.p', 'r')
    ...
    def __getitem__(self, index):
        ...
        doc2 = get_index_line_from_file(self.docs_file, self.docs_offset_list, d1_id)

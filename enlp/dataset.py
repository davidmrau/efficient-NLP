...
class TriplesSequential(IterableDataset):
    def __init__(self, triples_path, id2query, id2doc, max_query_len=64, max_complete_len=510, max_doc_len=None, rand_p=0):
        # "open" triplets file
...
def get_data_loaders_robust_strong(cfg, indices_test, query_fi, docs_fi, ranking_results):
    ...
    train_dataset = TriplesSequential(ranking_results, query_fi, docs_fi, max_query_len=max_query_len, max_complete_len=max_complete_len, max_doc_len=max_doc_len)

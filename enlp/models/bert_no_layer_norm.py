...
class BertEncoder(nn.Module):
	def __init__(self, config):
		...
		self.layer = nn.ModuleList([BertLayer(config, is_last_layer = (i == config.num_hidden_layers-1) ) for i in range(config.num_hidden_layers)])
...
class BertModelNoOutLayerNorm(BertPreTrainedModel):
	"""

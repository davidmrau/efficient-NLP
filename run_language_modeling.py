...
from enlp.dataset import MSMarcoLM
...
def mask_tokens(inputs: torch.Tensor, tokenizer: PreTrainedTokenizer, args) -> Tuple[torch.Tensor, torch.Tensor]:
    ...
    special_tokens_mask, segment_ids_mask = [], []
    ...
    return inputs, labels, torch.LongTensor(segment_ids_mask)
...
# multi-gpu eval
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            model.train()
            if args.exclude:
                outputs = model(inputs, masked_lm_labels=labels, token_type_ids=segment_mask) if args.mlm else model(inputs, labels=labels)
            else:
...
def main():
    ...
    # Required parameters
    parser.add_argument(
        "--train_data_file", default='data/msmarco/qrels.dev.tsv', type=str, required=True, help="The input training data file (a text file)."
    )
    parser.add_argument(
        "--output_dir",
        type=str,
    ...
    parser.add_argument("--query_path", type=str, default=f'queries.train.bert.tsv', help="Query path.")
